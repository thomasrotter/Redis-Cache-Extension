...
public class RedisConnection {
	...
	public static JedisSentinelPool init(String cacheName, Struct arguments){
		...
		try{
			...
			Set<String> sentinels = new HashSet<String>(Arrays.asList(caster.toString(arguments.get("sentinels")).split("\n")));

			instance.put(cacheName, new JedisSentinelPool(masterName, sentinels));
