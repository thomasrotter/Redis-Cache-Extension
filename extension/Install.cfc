<cfcomponent>
	...
	<cfscript>
		variables.name = "RedisSentinelCache";
		variables.id = "lucee.extension.io.cache.RedisSentinelCache";
		variables.jar = "redis-sentinel-cache.jar";
		variables.driver = "RedisSentinelCache.cfc";
		variables.jars = "#variables.jar#,jedis-2.7.2.jar,commons-pool2-2.4.1.jar";
	</cfscript>
